...
Lexicon::Highcharts.new(
    :axis => {
        in_bytes_obj   => {:type=>'area', :name=>'InBits',   :color=>'#00ff00'},
        out_bytes_obj  => {:type=>'line', :name=>'OutBits',  :color=>'#0000ff'},
        ucast_pkts_obj => {:type=>'line', :name=>'Unicast Packets', :color=>'#ff9933', :yAxis => 1}
    },
    :data_url => 'data.json',
    :live_url => 'live.json',
